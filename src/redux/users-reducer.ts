...
const usersReducer = (state = initialState, action: ActionsType): initialStateTypes => {
    switch (action.type) {
        case FOLLOW:
            return {
                ...state,
...
type ActionsType = followSuccessType | unfollowSuccessType | setUsersType | setCurrentPageType | setTotalUsersCountType
